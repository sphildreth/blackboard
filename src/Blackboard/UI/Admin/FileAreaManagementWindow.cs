    ...
    public class FileAreaManagementWindow : Window
    {
        ...
        private async void LoadData()
        {
            try
            {
                ...
                _areaListView.SetSource<string>(new System.Collections.ObjectModel.ObservableCollection<string>(areaItems));
                ...
                _fileListView.SetSource<string>(new System.Collections.ObjectModel.ObservableCollection<string>(fileItems));
